...
--ALTER TABLE llx_kreaproducts_nutritional ADD CONSTRAINT llx_kreaproducts_nutritional_fk_field FOREIGN KEY (fk_field) REFERENCES llx_kreaproducts_myotherobject(rowid);
