...
$title = $langs->trans('NutritialCalculator');
$helpurl = '';
...
llxHeader('', $title, $helpurl, '', 0, 0, '', '', '', 'mod-kreaproducts page-card_kreaproducts_nuttable');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'kreaproducts_nuttable', $titre, -1, $picto);
	...
	KreaProductsNutritionalCalculator::computeAndDisplayNutritional($id);
} else {
