...
assertSameValue(true, strpos((string) $moduleSource, "\$this->version = '4.5.9'") !== false, 'The module descriptor must use the audited release version.');
...
assertSameValue('4.5.9', $mobilePackage['version'] ?? '', 'The mobile package version must match the module release.');
assertSameValue('4.5.9', $mobilePackageLock['version'] ?? '', 'The mobile lockfile version must match the module release.');
assertSameValue('4.5.9', $mobilePackageLock['packages']['']['version'] ?? '', 'The mobile lockfile root package must match the module release.');
