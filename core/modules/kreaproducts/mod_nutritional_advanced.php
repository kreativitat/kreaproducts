...
/**
 * \file       htdocs/core/modules/kreaproducts/mod_nutritional_advanced.php
 * \ingroup    kreaproducts
 * \brief      File containing class for advanced numbering model of Nutritional
 */
...
/**
 *	Class to manage the Advanced numbering rule for Nutritional
 */
class mod_nutritional_advanced extends ModeleNumRefNutritional
{
	/**
	...
	public function info($langs)
	{
		...
		$tooltip .= $langs->trans("GenericMaskCodes4a", $langs->transnoentities("Nutritional"), $langs->transnoentities("Nutritional"));
	...
	public function getNextValue($object)
	{
		...
		$numFinal = get_next_value($db, $mask, 'kreaproducts_nutritional', 'ref', '', '', $date);
