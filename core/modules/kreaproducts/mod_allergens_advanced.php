...
/**
 * \file       htdocs/core/modules/kreaproducts/mod_allergens_advanced.php
 * \ingroup    kreaproducts
 * \brief      File containing class for advanced numbering model of Allergens
 */

dol_include_once('/kreaproducts/core/modules/kreaproducts/modules_allergens.php');


/**
 *	Class to manage the Advanced numbering rule for Allergens
 */
class mod_allergens_advanced extends ModeleNumRefAllergens
{
	/**
	...
	public function info($langs)
	{
		...
		$tooltip = $langs->trans("GenericMaskCodes", $langs->transnoentities("Allergens"), $langs->transnoentities("Allergens"));
		$tooltip .= $langs->trans("GenericMaskCodes2");
		$tooltip .= $langs->trans("GenericMaskCodes3");
		$tooltip .= $langs->trans("GenericMaskCodes4a", $langs->transnoentities("Allergens"), $langs->transnoentities("Allergens"));
	 ...
	 *
	 *  @param  Allergens		$object		Object we need next value for
	...
	public function getNextValue($object)
	{
		...
		$numFinal = get_next_value($db, $mask, 'kreaproducts_allergens', 'ref', '', '', $date);
