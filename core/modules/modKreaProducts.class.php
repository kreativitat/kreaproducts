...
class modKreaProducts extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->cronjobs = array(
			...
			//      'label' => 'MyJob label',
			//      'jobtype' => 'method',
			//      'class' => '/kreaproducts/class/myobject.class.php',
			//      'objectname' => 'MyObject',
		...
		$this->rights[$r][1] = 'Read objects of KreaProducts'; // Permission label
		$this->rights[$r][4] = 'myobject';
		$this->rights[$r][5] = 'read'; // In php code, permission will be checked by test if ($user->hasRight('kreaproducts', 'myobject', 'read'))
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", ($o * 10) + 2); // Permission id (must not be already used)
		$this->rights[$r][1] = 'Create/Update objects of KreaProducts'; // Permission label
		$this->rights[$r][4] = 'myobject';
		$this->rights[$r][5] = 'write'; // In php code, permission will be checked by test if ($user->hasRight('kreaproducts', 'myobject', 'write'))
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", ($o * 10) + 3); // Permission id (must not be already used)
		$this->rights[$r][1] = 'Delete objects of KreaProducts'; // Permission label
		$this->rights[$r][4] = 'myobject';
		$this->rights[$r][5] = 'delete'; // In php code, permission will be checked by test if ($user->hasRight('kreaproducts', 'myobject', 'delete'))
		$r++;
		*/
		...
		$this->menu[$r++] = array(
			...
			'perms'=>'1', // Use 'perms'=>'$user->hasRight("kreaproducts", "myobject", "read")' if you want your menu with a permission rules
			'target'=>'',
		...
		$this->menu[$r++]=array(
			...
			'position'=>1000+$r,
			'enabled'=>'isModEnabled("kreaproducts")', // Define condition to show or hide menu entry. Use 'isModEnabled("kreaproducts")' if entry must be visible if module is enabled.
			'perms'=>'$user->hasRight("kreaproducts", "myobject", "read")',
			'target'=>'',
			'user'=>2,				                // 0=Menu for internal users, 1=external users, 2=both
		);
		$this->menu[$r++]=array(
			'fk_menu'=>'fk_mainmenu=kreaproducts,fk_leftmenu=myobject',	    // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>'New_MyObject',
			'mainmenu'=>'kreaproducts',
			'leftmenu'=>'kreaproducts_myobject_new',
			'url'=>'/kreaproducts/myobject_card.php?action=create',
			'langs'=>'kreaproducts@kreaproducts',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>1000+$r,
			...
			'perms'=>'$user->hasRight("kreaproducts", "myobject", "write")'
			'target'=>'',
			'user'=>2,				                // 0=Menu for internal users, 1=external users, 2=both
		);
		$this->menu[$r++]=array(
			...
			'titre'=>'List_MyObject',
			'mainmenu'=>'kreaproducts',
			'leftmenu'=>'kreaproducts_myobject_list',
			'url'=>'/kreaproducts/myobject_list.php',
			'langs'=>'kreaproducts@kreaproducts',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>1000+$r,
			'enabled'=>'isModEnabled("kreaproducts")', // Define condition to show or hide menu entry. Use 'isModEnabled("kreaproducts")' if entry must be visible if module is enabled.
			'perms'=>'$user->hasRight("kreaproducts", "myobject", "read")'
		...
		*/
		...
		$this->export_icon[$r]='myobject@kreaproducts';
		// Define $this->export_fields_array, $this->export_TypeFields_array and $this->export_entities_array
		$keyforclass = 'MyObject'; $keyforclassfile='/kreaproducts/class/myobject.class.php'; $keyforelement='myobject@kreaproducts';
		include DOL_DOCUMENT_ROOT.'/core/commonfieldsinexport.inc.php';
		//$this->export_fields_array[$r]['t.fieldtoadd']='FieldToAdd'; $this->export_TypeFields_array[$r]['t.fieldtoadd']='Text';
		//unset($this->export_fields_array[$r]['t.fieldtoremove']);
		//$keyforclass = 'MyObjectLine'; $keyforclassfile='/kreaproducts/class/myobject.class.php'; $keyforelement='myobjectline@kreaproducts'; $keyforalias='tl';
		//include DOL_DOCUMENT_ROOT.'/core/commonfieldsinexport.inc.php';
		$keyforselect='myobject'; $keyforaliasextra='extra'; $keyforelement='myobject@kreaproducts';
		include DOL_DOCUMENT_ROOT.'/core/extrafieldsinexport.inc.php';
		//$keyforselect='myobjectline'; $keyforaliasextra='extraline'; $keyforelement='myobjectline@kreaproducts';
		//include DOL_DOCUMENT_ROOT.'/core/extrafieldsinexport.inc.php';
		...
		$this->import_icon[$r]='myobject@kreaproducts';
		$this->import_tables_array[$r] = array('t' => MAIN_DB_PREFIX.'kreaproducts_myobject', 'extra' => MAIN_DB_PREFIX.'kreaproducts_myobject_extrafields');
		...
		$this->import_fieldshidden_array[$r] = array('extra.fk_object' => 'lastrowid-'.MAIN_DB_PREFIX.'kreaproducts_myobject');
		...
		$this->import_convertvalue_array[$r] = array(
			't.ref' => array(
				'rule'=>'getrefifauto',
				'class'=>(!getDolGlobalString('KREAPRODUCTS_MYOBJECT_ADDON') ? 'mod_myobject_standard' : getDolGlobalString('KREAPRODUCTS_MYOBJECT_ADDON')),
				'path'=>"/core/modules/commande/".(!getDolGlobalString('KREAPRODUCTS_MYOBJECT_ADDON') ? 'mod_myobject_standard' : getDolGlobalString('KREAPRODUCTS_MYOBJECT_ADDON')).'.php'
				'classobject'=>'MyObject',
				'pathobject'=>'/kreaproducts/class/myobject.class.php',
			),
