...
/**
 * \file    test/phpunit/KreaProductsFunctionalTest.php
...
/**
 * Class KreaProductsFunctionalTest
 *
 ...
 *
 * @package Testkreaproducts
 */
class KreaProductsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modKreaProducts')->click();
		} else {
			// Disable the module
			$this->byHref('modKreaProducts')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/kreaproducts/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('kreaproducts/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/kreaproducts/admin/about.php');
		$this->authenticate();
		return $this->assertContains('kreaproducts/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('kreaproductswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modKreaProducts_KreaProductsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modKreaProducts_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
