...
- Explained blocked recipe components and company switching when nutrition and allergen copying fails.
...
- Reconstructed open-inventory virtual stock from the live ledger at billing close.

## [4.16.3] - 2026-08-17

### Fixed

- Displayed inventory virtual stock at the configured billing-day closing time.
...
- Fixed calculated nutrition and allergen rendering after loading recursive product costs.
